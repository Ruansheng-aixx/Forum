...
<form class="layui-form" id="noticeForm">
    <h1 style="margin-left: 115px">发布公告</h1>
    <br>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline layui-input-wrap">
            <input type="text" name="noticeName" lay-verify="required" autocomplete="off" lay-affix="clear" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">公告</label>
        <div class="layui-input-block">
            <textarea name="noticeContext" id="noticeContext" lay-verify="required"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button type="submit" class="layui-btn" lay-submit lay-filter="demo12">立即提交</button>
...
<script>
    $(function() {
        var editor2 = KindEditor.create('#noticeContext', {
            filterMode: false,
            width:'75%',
            height:'400px',
                ...
                success: function(result){
                    ...
                    if(result.code==200){
                        layer.msg('发布成功', {icon: 0, time: 500},function (){
                            loadPage('${pageContext.request.contextPath}/notice/toAddNotice')
                        });
                    }else{
                        alert(result.msg);
                    }
