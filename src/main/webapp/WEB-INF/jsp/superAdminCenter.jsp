        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:loadPage('${pageContext.request.contextPath}/user/toAddAdmin');">添加管理员</a></dd>
                        <dd><a href="javascript:loadPage('${pageContext.request.contextPath}/user/toAdminList');">管理员查询</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
